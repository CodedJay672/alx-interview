...
# Defining a function to print the board configuration in a specific format
...
def solve_n_queens(board, col):
  ...
  for i in range(n):
    ...
    if is_safe(board, i, col):
      ...
      # Recur to place the rest of the queens and set res to true if any solution is found
...
# Getting the value of n from the command line argument and checking if it is an integer greater or equal to 4
try:
  n = int(sys.argv[1])
except ValueError:
