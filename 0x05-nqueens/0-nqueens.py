#!/usr/bin/python3
"""
This module tries to solve the nqueens
puzzle.
...
# Defining a function to check if a position is safe for a queen
def is_safe(board, row, col):
    ...
    # Defining a function to print the board configuration 
    ...
    def print_board(board):
        ...
        # Defining a recursive function to solve the n-queens problem and print all solutions
        def solve_n_queens(board, col):
            ...
            for i in range(n):
                ...
                if is_safe(board, i, col):
                    ...
                    # Recur to place the rest of the queens and
                    # set res to true if any solution is found
            ...
            if len(sys.argv) != 2:
                ...
                # Getting the value of n from the command line argument and 
                # checking if it is an integer greater or equal to 4
                try:
                    n = int(sys.argv[1])
                except ValueError:
